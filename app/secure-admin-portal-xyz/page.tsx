...
type Tab = "overview" | "vendors" | "users" | "categories";
...
export default function AdminDashboard() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans overflow-hidden text-gray-900 relative">
      {/* Toast */}
      {toast && (
        <div className={`fixed top-4 right-4 z-50 px-4 py-3 rounded-xl text-sm font-medium shadow-lg animate-in fade-in slide-in-from-top-4 duration-300 ${toast.type === "error" ? "bg-red-600" : "bg-gray-900"} text-white`}>
          {toast.msg}
        </div>
      )}
